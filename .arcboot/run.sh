...
qemu-system-aarch64 -M virt -cpu cortex-a72 -bios aarch64/qemu/OVMF_EFI.fd -drive file=fat:rw:diskImage -drive file=aarch64/qemu/VARS.fd -serial mon:stdio -nographic -nodefaults -device virtio-rng-pci -smp cpus=8 -net none &> out
